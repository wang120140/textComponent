class PIXIScroll extends PIXI.Container {
  constructor($options = {}) {
    ...
    this.scrollBarVerticalStyle = null;
  ...
  addedToStage() {
    ...
    if (this.scrollContent) {
      ...
      if(!this.scrollBarVertical){
        ...
        this.scrollBarVertical.beginFill(0x2b007c, 0.8);
        this.scrollBarVertical.drawRect(0, 0, 20, this.scaleDiffVertical * this.scrollHeight);
      ...
      this.scrollBarHorizontal.beginFill(0x2b007c,0.8);
      this.scrollBarHorizontal.drawRect(0,0,this.scaleDiffHorizontal * this.scrollWidth,20);
      ...
      if(this.setVertical && !this.setHorizontal){
